...
const C: Record<string, RGB> = {
  deepest:  [16, 43, 30],   // #102B1E
  dark:     [30, 92, 64],   // #1E5C40
  mid:      [46, 138, 90],  // #2E8A5A
  bright:   [61, 184, 114], // #3DB872
  light:    [125, 212, 164],// #7DD4A4
  pale:     [192, 237, 213],// #C0EDD5
  palest:   [235, 249, 242],// #EBF9F2
  white:    [255, 255, 255],
  slate:    [120, 144, 156],
  ink:      [15, 23, 42],
};
const fill = (doc: PdfDoc, c: RGB) => doc.setFillColor(c[0], c[1], c[2]);
const text = (doc: PdfDoc, c: RGB) => doc.setTextColor(c[0], c[1], c[2]);
const draw = (doc: PdfDoc, c: RGB) => doc.setDrawColor(c[0], c[1], c[2]);
