-- Add explicit actual return marker for pesantren permission records.

alter table public.pp_perizinan
add column if not exists waktu_kembali_aktual timestamptz;
