-- Store and expose signer metadata for public letter validation pages.

alter table public.pp_surat_keluar
add column if not exists penandatangan jsonb not null default '[]'::jsonb;

alter table public.smp_surat_keluar
add column if not exists penandatangan jsonb not null default '[]'::jsonb;
...
begin
  ...
  return jsonb_build_object(
    ...
    'surat', jsonb_build_object(
      ...
      'penandatangan', coalesce(v_surat.penandatangan, '[]'::jsonb),
